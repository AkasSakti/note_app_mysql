...
class _EditState extends State<Edit> {
    ...
    try {
      final response = await http.get(Uri.parse(
        ...
        //get detail data with id
          "http://10.0.2.2/latihan/note_app/detail.php?id='${widget.id}'"));
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://10.0.2.2/latihan/note_app/update.php"),
        body: {
          "id": widget.id,
          "title": title.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://10.0.2.2/latihan/note_app/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
